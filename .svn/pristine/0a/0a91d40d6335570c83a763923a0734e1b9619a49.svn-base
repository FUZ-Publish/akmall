	...
	this.get_naver_userprofile = function(callback_func1) {
		...
		success: function (result) {
			//if((typeof(result.response)!='undefined')) {
				inner_profileParams.age           = ((typeof(result.response.age)!='undefined') && (result.response.age != "") ) ? result.response.age : "";
				inner_profileParams.birthday      = ((typeof(result.response.birthday)!='undefined') && (result.response.birthday != "") ) ? result.response.birthday : "";
				inner_profileParams.email         = ((typeof(result.response.email)!='undefined') && (result.response.email != "") ) ? result.response.email : "";
				inner_profileParams.enc_id        = ((typeof(result.response.enc_id)!='undefined') && (result.response.enc_id != "") ) ? result.response.enc_id : "";
				inner_profileParams.gender        = ((typeof(result.response.gender)!='undefined') && (result.response.gender != "") ) ? result.response.gender : "";
				inner_profileParams.id            = ((typeof(result.response.id)!='undefined') && (result.response.id != "") ) ? result.response.id : "";
				inner_profileParams.nickname      = ((typeof(result.response.nickname)!='undefined') && (result.response.nickname != "") ) ? result.response.nickname : "";
				inner_profileParams.profile_image = ((typeof(result.response.profile_image)!='undefined') && (result.response.profile_image != "") ) ? result.response.profile_image : "";
				inner_profileParams.name 		  = ((typeof(result.response.name)!='undefined') && (result.response.name != "") ) ? result.response.name : "";
			//}
			eval(callback_func1);
		},
