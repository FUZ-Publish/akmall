...
function TopArea(){
	...
	document.write('<li><a href="../../html/menu/menuList0101.html">퍼블리싱 리스트</a></li>');
	document.write('</ul>');
	document.write('</div>');
...
function LeftMenuRULE(){
	...
	document.write('		<h2 class="lnbtit">HTML가이드</h2>');
	...
	document.write('				</ul>');
	document.write('			</li>');
	document.write('			<li><a href="02_html.html">HTML</a></li>');
	document.write('			<li><a href="03_text.html">Text</a></li>');
	document.write('			<li><a href="04_form.html">Form/Button</a></li>');
	document.write('			<li><a href="05_tab.html">Tab</a></li>');
	document.write('			<li><a href="06_table.html">Table/Grid</a></li>');	
	document.write('			<li><a href="07_list.html">List</a></li>');
	document.write('			<li><a href="08_layer.html">Layer</a></li>');
	document.write('			<li><a href="09_content.html">Content</a></li>');		
	document.write('		</ul>');
	document.write('	</div>');
...
function LeftMenuMobile(){
	...
	document.write('	<div id="lnbArea">');
	document.write('		<ul id="lnb">');
	document.write('			<li><a href="../../html/mobile/rule0101.html">레이어팝업</a></li>');
	document.write('			<li><a href="../../html/mobile/rule0201.html">서식가이드</a></li>');
	document.write('			<li><a href="../../html/mobile/rule0301.html">테이블가이드</a></li>');
	document.write('			<li><a href="../../html/mobile/rule0401.html">텍스트가이드</a></li>');
	document.write('			<li><a href="../../html/mobile/rule0501.html">탭/버튼 가이드</a></li>');
	document.write('			<li><a href="../../html/mobile/rule0601.html">박스(Grid)형태 가이드</a></li>');
	/*
...
function LeftMenu01(){
	...
	document.write('	<div id="lnbArea">');
	document.write('		<ul id="lnb">');
	document.write('			<li><a href="../../html/menu/menuList0101.html">Web</a></li>');
	//document.write('			<li><a href="../../html/menu/menuList0101.html">Mobile</a></li>');
	/*
	document.write('			<li><a href="#">카테고리02</a>');
	document.write('				<ul class="lnb2depth">');
	document.write('					<li><a href="#">카테고리02-1</a></li>');
